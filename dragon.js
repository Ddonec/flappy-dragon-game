(function (window) {
 ...
 function renderGameOver() {
    //game over logo
    context.drawImage(gameOverCanvas, bounds.getCenterX() - logoCanvas.width / 2, canvas.height * 0.2);

    var instruction = "Click or tap to flap again.";
    context.font = "bold normal 24px sans-serif";
    context.fillStyle = "#FFFFFF";
    context.fillText(instruction, bounds.getCenterX() - context.measureText(instruction).width / 2, canvas.height * 0.25 + gameOverCanvas.height);
    renderScore();
 ...
 function renderInstructions() {
    ...
    context.font = "bold normal 24px sans-serif";
    context.fillStyle = "#FFFFFF";
    context.fillText(instruction, bounds.getCenterX() - context.measureText(instruction).width / 2, canvas.height * 0.2);
 }
 ...
 var tubeGapHeight = 430; //needs some logic
 var tubesGapWidth;
 var tubes;
 var tubeWidth = 200; //needs some logic
 var minTubeHeight = 400; //needs some logic
 ...
 function createCityGraphic() {
    ...
    for (iterator = 0; iterator < canvas.width; iterator += houseWidth + 8) {
       ...
       houseHeight = Sakri.MathUtil.getRandomNumberInRange(cityGraphicHeight * 0.5, cityGraphicHeight - maxCloudRadius * 0.8);
